      ...
      <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-6 py-4">
        ...
        {review && (
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => exportReview(language, code, review, reviewTime)}
      ...
      <div className="p-6 sm:p-8">
        {error ? (
          ...
          <div className="py-10 text-center text-slate-500">
            ...
            <p className="text-lg">Your AI review will appear here.</p>
            <p className="mt-2 text-sm">
              Paste your code and select <strong>Review Code</strong>.
            </p>
          </div>
        ) : (
                  ...
                  return match ? (
                    <div className="relative my-6 overflow-hidden rounded-xl">
                      <button
                        ...
                        className="absolute right-3 top-3 z-10 inline-flex items-center gap-1 rounded-md bg-slate-700 px-3 py-1 text-xs text-white hover:bg-slate-600"
                      >
                        <ClipboardCopy size={13} aria-hidden="true" /> Copy code
                      </button>
                      <SyntaxHighlighter
                        language={match[1]}
                        style={oneDark}
